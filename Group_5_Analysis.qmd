...
$$
\mbox{ln}(\frac{p}{1-p}) = \alpha + \beta_{\mbox{Year}} \cdot \mathbb{I}_{\mbox{Year}}(x)
$$
...
$$
\mbox{ln}(\frac{p}{1-p}) = \alpha + \beta_{\mbox{AgeGroup}} \cdot \mathbb{I}_{\mbox{AgeGroup}}(x) + \beta_{\mbox{Sex}} \cdot \mathbb{I}_{\mbox{Sex}}(x) + \beta_{\mbox{Employment}} \cdot \mathbb{I}_{\mbox{Employment}}(x)
$$
